...
return array(
	...
	*/
	...
	"between"              => array(
		"numeric" => "请修改数字:attribute大小在:min和:max之间",
		"file"    => ":attribute大小必须在:min和:maxKB之间",
		"string"  => "请修改:attribute长度在:min和:max之间",
		"array"   => "请增加或减少:attribute数量在:min和:max之间"
	),
	"boolean"              => "The :attribute field must be true or false",
	"confirmed"            => "The :attribute confirmation does not match.",
	"date"                 => "请修改:attribute格式，:attribute不是一个有效的日期",
